import { Planet, PlanetName, SectionName } from "../_types";

export function findPlanet(planetName: PlanetName) {
...
export function getGeneralPlanetFacts(planetName: PlanetName) {
...
export function getPlanetSectionData(
	planetName: PlanetName,
	sectionName: SectionName
) {
	const planet = findPlanet(planetName);
	return planet[sectionName];
}

export function getPlanetImages(planetName: PlanetName) {
	const planet = findPlanet(planetName);
